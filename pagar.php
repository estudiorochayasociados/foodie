...
$codPedido = substr(md5(uniqid(rand())), 0, 10);
?>

<div class="container">
    <?php
    if(isset($_SESSION["usuarios"])) {
        $funciones->headerMove(URL."/che");  
    }
    ...
    var_dump($usuarios->view_sesion());   
    ?>
    <div class="col-md-8">
        <form method="post" class="row" >
          <div class="row">
            <div class="col-md-12">Nombre:<br/>
            ...
            <div class="col-md-12">Apellido:<br/>
