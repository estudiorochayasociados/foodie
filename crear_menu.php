...
if (isset($_POST["crear_menu"])):
    ...
    $variante1 = $funcion->antihack_mysqli(isset($variante1) ? $variante1 : '');
    $variante2 = $funcion->antihack_mysqli(isset($variante2) ? $variante2 : '');
    $adicional1 = $funcion->antihack_mysqli(isset($adicional1) ? $adicional1 : '');
    $adicional2 = $funcion->antihack_mysqli(isset($adicional2) ? $adicional2 : '');
