                ...
                <div class="box_style_2" id="main_menu">
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" value="Córdoba" value="<?= $usuarioData['provincia'] ?>"
                                       name="provinciaInvitado">
                                <div class="form-group">
                                    <label>Ciudad</label>
                                    <select class="form-control" name="ciudadInvitado" id="ciudadInvitado">
                                        ...
                                        <option value="La Francia" <?php if ($usuarioData['localidad'] == 'La Francia') echo 'selected'; ?>>
                                            La Francia
                                        </option>
                                        <option value="Devoto" <?php if ($usuarioData['localidad'] == 'Devoto') echo 'selected'; ?>>
                                            Devoto
                                        </option>
                                    </select>
                                </div>
