      ...
      <div class="col-md-offset-3 col-md-6">
        <div class="box_style_2">
          ...
          <div id="confirm">
            ...
            <h3>¡Bienvenido/a!</h3>
            <p>
              Ya podés empezar a vender desde la plataforma, lo único que necesitás es añadir los menús que ofrecés.
            </p>        
          </div>
          <a class="btn_full btn btn-primary" href="<?=URL;?>/crear_menu">Añadir menús <i class="icon-food"></i></a>
        </div>
      </div>
    </div><!-- End row -->
  </div><!-- End container -->
