...
<link rel="apple-touch-icon" type="image/x-icon" href="<?= URL ?>/assets/img/apple-touch-icon-57x57-precomposed.png">
<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72"
href="<?= URL ?>/assets/img/apple-touch-icon-72x72-precomposed.png">
<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114"
href="<?= URL ?>/assets/img/apple-touch-icon-114x114-precomposed.png">
